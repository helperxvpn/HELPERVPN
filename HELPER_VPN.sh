...
echo -e "${SKY}${BOLD}╠════════════════════════════════════════════════╣${NC}"
printf "${SKY}${BOLD}║${NC} ${WHITE}Domain${NC}: ${LIME}%-38s${NC}${SKY}${BOLD}║${NC}\n" "$DOM"
printf "${SKY}${BOLD}║${NC} ${WHITE}IP    ${NC}: ${LIME}%-38s${NC}${SKY}${BOLD}║${NC}\n" "$IP"
echo -e "${SKY}${BOLD}╠═══════════════════╦════════════════════════════╣${NC}"
echo -e "${SKY}${BOLD}║${NC} ${GREEN}${BOLD}[ SSH ACCOUNT ]${NC}   ${SKY}${BOLD}║${NC} ${PINK}${BOLD}[ XRAY ACCOUNT ]${NC}           ${SKY}${BOLD}║${NC}"
echo -e "${SKY}${BOLD}╠═══════════════════╩════════════════════════════╣${NC}"
echo ""
printf " ${GREEN}%-3s${NC} %-18s ${PINK}%-3s${NC} %s\n"  "1)" "Create SSH Acct"   "8)"  "Create VMess"
printf " ${GREEN}%-3s${NC} %-18s ${PINK}%-3s${NC} %s\n"  "2)" "Delete SSH Acct"   "9)"  "Create VLESS"
printf " ${GREEN}%-3s${NC} %-18s ${PINK}%-3s${NC} %s\n"  "3)" "Extend SSH Acct"  "10)"  "Create Trojan"
printf " ${GREEN}%-3s${NC} %-18s ${PINK}%-3s${NC} %s\n"  "4)" "List SSH Accts"   "11)"  "Delete Xray"
printf " ${GREEN}%-3s${NC} %-18s ${PINK}%-3s${NC} %s\n"  "5)" "Trial SSH 1day"   "12)"  "Extend Xray"
printf " ${GREEN}%-3s${NC} %-18s ${PINK}%-3s${NC} %s\n"  "6)" "Active Logins"    "13)"  "List Xray"
printf " ${GREEN}%-3s${NC} %-18s ${PINK}%-3s${NC} %s\n"  "7)" "Kill Multi Login" "14)"  "Trial Xray 1day"
echo ""
echo -e "${SKY}${BOLD}╠════════════════════════════════════════════════╣${NC}"
...
echo ""
echo -e "${SKY}${BOLD}╔════════════════════════════════════════════════╗${NC}"
echo -e "${SKY}${BOLD}║${NC}   ${GOLD}${BOLD}✔  INSTALLATION  COMPLETE  ✔${NC}               ${SKY}${BOLD}║${NC}"
echo -e "${SKY}${BOLD}╠════════════════════════════════════════════════╣${NC}"
printf "${SKY}${BOLD}║${NC} ${WHITE}Domain   ${NC}: ${LIME}%-36s${NC}${SKY}${BOLD}║${NC}\n" "$DOMAIN"
printf "${SKY}${BOLD}║${NC} ${WHITE}Server IP${NC}: ${LIME}%-36s${NC}${SKY}${BOLD}║${NC}\n" "$MY_IP"
printf "${SKY}${BOLD}║${NC} ${WHITE}SSL Cert ${NC}: %-47b${SKY}${BOLD}║${NC}\n" "$SSL_TAG_STATUS"
echo -e "${SKY}${BOLD}╠════════════════════════════════════════════════╣${NC}"
echo -e "${SKY}${BOLD}║${NC} ${ORANGE}${BOLD}SERVICE            PORT         STATUS${NC}       ${SKY}${BOLD}║${NC}"
echo -e "${SKY}${BOLD}╠════════════════════════════════════════════════╣${NC}"
printf "${SKY}${BOLD}║${NC} %-18s %-13s %-10b${SKY}${BOLD}║${NC}\n" "OpenSSH"            "22"              "$(svc_tag ssh)"
printf "${SKY}${BOLD}║${NC} %-18s %-13s %-10b${SKY}${BOLD}║${NC}\n" "WS-Proxy"           "80 /ssh-ws"      "$(svc_tag ws-proxy)"
printf "${SKY}${BOLD}║${NC} %-18s %-13s %-10b${SKY}${BOLD}║${NC}\n" "WSS-Proxy"          "443 /ssh-ws"     "$(svc_tag nginx)"
printf "${SKY}${BOLD}║${NC} %-18s %-13s %-10b${SKY}${BOLD}║${NC}\n" "Dropbear"           "109/143"         "$(svc_tag dropbear)"
printf "${SKY}${BOLD}║${NC} %-18s %-13s %-10b${SKY}${BOLD}║${NC}\n" "Stunnel5"           "447/777"         "$(svc_tag stunnel4)"
printf "${SKY}${BOLD}║${NC} %-18s %-13s %-10b${SKY}${BOLD}║${NC}\n" "BadVPN UDPGW"       "7100-7300"       "$BADVPN_TAG_STATUS"
printf "${SKY}${BOLD}║${NC} %-18s %-13s %-10b${SKY}${BOLD}║${NC}\n" "Xray (V/VL/TR)"     "80/443"          "$(svc_tag xray)"
