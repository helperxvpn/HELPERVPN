...
clear
echo -e "${SKY}${BOLD}╔══════════════════════════════════════════════════════════╗${NC}"
echo -e "${SKY}${BOLD}║${NC}      ${GOLD}${BOLD}H E L P E R   V P N   A U T O S C R I P T${NC}        ${SKY}${BOLD}║${NC}"
echo -e "${SKY}${BOLD}║${NC}         ${LIME}Ubuntu 24.04 LTS${NC}  ${ORANGE}─── All Features ───${NC}        ${SKY}${BOLD}║${NC}"
echo -e "${SKY}${BOLD}╚══════════════════════════════════════════════════════════╝${NC}"
sleep 1
...
# =====================================================================
# 6. OPENSSH — enable password auth
# =====================================================================
...
echo -e "${SKY}${BOLD}╔══════════════════════════════════════════════════════════╗${NC}"
echo -e "${SKY}${BOLD}║${NC}              ${GOLD}${BOLD}✦  H E L P E R   V P N   M E N U  ✦${NC}          ${SKY}${BOLD}║${NC}"
echo -e "${SKY}${BOLD}╠══════════════════════════════════════════════════════════╣${NC}"
printf "${SKY}${BOLD}║${NC}  ${WHITE}Domain${NC} : ${LIME}%-48s${NC}${SKY}${BOLD}║${NC}\n" "$DOM"
printf "${SKY}${BOLD}║${NC}  ${WHITE}IP    ${NC} : ${LIME}%-48s${NC}${SKY}${BOLD}║${NC}\n" "$IP"
echo -e "${SKY}${BOLD}╠════════════════════════╦═════════════════════════════════╣${NC}"
echo -e "${SKY}${BOLD}║${NC}  ${GREEN}${BOLD}[ SSH ACCOUNT ]${NC}         ${SKY}${BOLD}║${NC}  ${PINK}${BOLD}[ XRAY ACCOUNT ]${NC}               ${SKY}${BOLD}║${NC}"
echo -e "${SKY}${BOLD}╠════════════════════════╩═════════════════════════════════╣${NC}"
echo ""
printf "  ${GREEN}%-3s${NC} %-22s  ${PINK}%-3s${NC} %s\n"  "1)" "Create SSH Account"    "8)"  "Create VMess Account"
printf "  ${GREEN}%-3s${NC} %-22s  ${PINK}%-3s${NC} %s\n"  "2)" "Delete SSH Account"    "9)"  "Create VLESS Account"
printf "  ${GREEN}%-3s${NC} %-22s  ${PINK}%-3s${NC} %s\n"  "3)" "Extend SSH Account"   "10)"  "Create Trojan Account"
printf "  ${GREEN}%-3s${NC} %-22s  ${PINK}%-3s${NC} %s\n"  "4)" "List SSH Accounts"    "11)"  "Delete Xray Account"
printf "  ${GREEN}%-3s${NC} %-22s  ${PINK}%-3s${NC} %s\n"  "5)" "Trial SSH (1 day)"    "12)"  "Extend Xray Account"
printf "  ${GREEN}%-3s${NC} %-22s  ${PINK}%-3s${NC} %s\n"  "6)" "Check Active Logins"  "13)"  "List Xray Accounts"
printf "  ${GREEN}%-3s${NC} %-22s  ${PINK}%-3s${NC} %s\n"  "7)" "Kill Multi Login"     "14)"  "Trial Xray (1 day)"
echo ""
echo -e "${SKY}${BOLD}╠══════════════════════════════════════════════════════════╣${NC}"
echo -e "${SKY}${BOLD}║${NC}  ${ORANGE}${BOLD}[ SYSTEM TOOLS ]${NC}                                         ${SKY}${BOLD}║${NC}"
echo -e "${SKY}${BOLD}╠══════════════════════════════════════════════════════════╣${NC}"
echo ""
printf "  ${YELLOW}%-3s${NC} %-22s  ${SKY}%-3s${NC} %s\n" "15)" "Running Services"     "20)" "Change DNS"
printf "  ${YELLOW}%-3s${NC} %-22s  ${SKY}%-3s${NC} %s\n" "16)" "Restart Services"     "21)" "BBR Status"
printf "  ${YELLOW}%-3s${NC} %-22s  ${SKY}%-3s${NC} %s\n" "17)" "Bandwidth Monitor"    "22)" "Swap RAM"
printf "  ${YELLOW}%-3s${NC} %-22s  ${SKY}%-3s${NC} %s\n" "18)" "RAM Monitor"          "23)" "Renew SSL"
printf "  ${YELLOW}%-3s${NC} %-22s  ${SKY}%-3s${NC} %s\n" "19)" "Clear Logs"           "24)" "Backup Data"
printf "  %-3s  %-22s  ${SKY}%-3s${NC} %s\n"              ""   ""                      "25)" "Restore Data"
echo ""
echo -e "${SKY}${BOLD}╠══════════════════════════════════════════════════════════╣${NC}"
echo -e "${SKY}${BOLD}║${NC}   ${RED}${BOLD}0)  Exit${NC}                                                  ${SKY}${BOLD}║${NC}"
echo -e "${SKY}${BOLD}╚══════════════════════════════════════════════════════════╝${NC}"
...
svc_tag() { systemctl is-active --quiet "$1" 2>/dev/null && echo -e "${LIME}✔ UP${NC}" || echo -e "${RED}✘ DOWN${NC}"; }
BADVPN_TAG_STATUS=$([[ $BADVPN_OK -eq 1 ]] && echo -e "${LIME}✔ READY${NC}" || echo -e "${RED}✘ SKIPPED${NC}")
SSL_TAG_STATUS=$([[ $CERT_OK -eq 1 ]] && echo -e "${LIME}✔ ISSUED${NC}" || echo -e "${YELLOW}! NOT ISSUED (HTTP only)${NC}")

echo ""
echo -e "${SKY}${BOLD}╔══════════════════════════════════════════════════════════╗${NC}"
echo -e "${SKY}${BOLD}║${NC}      ${GOLD}${BOLD}✔  I N S T A L L A T I O N   C O M P L E T E  ✔${NC}      ${SKY}${BOLD}║${NC}"
echo -e "${SKY}${BOLD}╠══════════════════════════════════════════════════════════╣${NC}"
printf "${SKY}${BOLD}║${NC}  ${WHITE}Domain   ${NC} : ${LIME}%-45s${NC}${SKY}${BOLD}║${NC}\n" "$DOMAIN"
printf "${SKY}${BOLD}║${NC}  ${WHITE}Server IP${NC} : ${LIME}%-45s${NC}${SKY}${BOLD}║${NC}\n" "$MY_IP"
printf "${SKY}${BOLD}║${NC}  ${WHITE}SSL Cert ${NC} : %-56b${SKY}${BOLD}║${NC}\n" "$SSL_TAG_STATUS"
echo -e "${SKY}${BOLD}╠══════════════════════════════════════════════════════════╣${NC}"
echo -e "${SKY}${BOLD}║${NC}  ${ORANGE}${BOLD}SERVICE                  PORT(S)          STATUS${NC}        ${SKY}${BOLD}║${NC}"
echo -e "${SKY}${BOLD}╠══════════════════════════════════════════════════════════╣${NC}"
printf "${SKY}${BOLD}║${NC}  %-22s %-18s %-13b${SKY}${BOLD}║${NC}\n" "OpenSSH"                   "22"              "$(svc_tag ssh)"
printf "${SKY}${BOLD}║${NC}  %-22s %-18s %-13b${SKY}${BOLD}║${NC}\n" "SSH WebSocket (WS)"        "80  /ssh-ws"     "$(svc_tag ws-proxy)"
printf "${SKY}${BOLD}║${NC}  %-22s %-18s %-13b${SKY}${BOLD}║${NC}\n" "SSH WebSocket (WSS)"       "443 /ssh-ws"     "$(svc_tag nginx)"
printf "${SKY}${BOLD}║${NC}  %-22s %-18s %-13b${SKY}${BOLD}║${NC}\n" "Dropbear"                  "109 / 143"       "$(svc_tag dropbear)"
printf "${SKY}${BOLD}║${NC}  %-22s %-18s %-13b${SKY}${BOLD}║${NC}\n" "Stunnel5"                  "447 / 777"       "$(svc_tag stunnel4)"
printf "${SKY}${BOLD}║${NC}  %-22s %-18s %-13b${SKY}${BOLD}║${NC}\n" "BadVPN UDPGW"              "7100/7200/7300"  "$BADVPN_TAG_STATUS"
printf "${SKY}${BOLD}║${NC}  %-22s %-18s %-13b${SKY}${BOLD}║${NC}\n" "Xray (VMess/VLESS/Trojan)" "80 / 443"        "$(svc_tag xray)"
printf "${SKY}${BOLD}║${NC}  %-22s %-18s %-13b${SKY}${BOLD}║${NC}\n" "Fail2ban"                  "─"               "$(svc_tag fail2ban)"
echo -e "${SKY}${BOLD}╠══════════════════════════════════════════════════════════╣${NC}"
echo -e "${SKY}${BOLD}║${NC}  ${PINK}${BOLD}Type: menu${NC}  ← to manage accounts & services              ${SKY}${BOLD}║${NC}"
echo -e "${SKY}${BOLD}╚══════════════════════════════════════════════════════════╝${NC}"
echo ""
